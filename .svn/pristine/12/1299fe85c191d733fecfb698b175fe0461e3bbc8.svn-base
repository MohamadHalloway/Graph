...
public class GraphController {
    ...
    public static TwoDimGraph loadGxl(TwoDimGraph graph, GraphViews views, Consumer<String> handleErrorMsg, File file) throws ParseException {
        ...
        TwoDimGraph tdg = null;
        try {
            tdg = in.read(String.join("\n", lines));
        } catch (Exception e) {
            throw new ParseException();
        }
